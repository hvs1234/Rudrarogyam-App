  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 w-[100%] max-md:grid-cols-1">
        <div className="w-[100%] flex flex-col justify-start items-start gap-[1rem] px-[8rem] py-[6rem] max-sm:px-[4rem] max-sm:py-[4rem] bg-[darkred]">
        ...
        <div className="w-[100%] flex flex-col justify-start items-start gap-[1rem] px-[8rem] py-[6rem] max-sm:px-[4rem] max-sm:py-[4rem] bg-[#3b2d1f]">
          <h2 className="text-[3rem] text-[white]">
